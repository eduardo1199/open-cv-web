...
int main() {
    ...
    auto imagemFilePathBiel = "C:\\Users\\Eduardo Soares\\Desktop\\Projetos Pessoais\\OpenCV\\OpenCV\\biel.png";
    auto imagemFilePathSushi = "C:\\Users\\Eduardo Soares\\Desktop\\Projetos Pessoais\\OpenCV\\OpenCV\\sushi.png";

    int nbits = 3;

    imagemPortadora = cv::imread(imagemFilePathSushi);
    imagemEscondida = cv::imread(imagemFilePathBiel);
